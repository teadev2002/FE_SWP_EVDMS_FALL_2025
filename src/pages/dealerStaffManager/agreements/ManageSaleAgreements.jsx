    ...
    },
{
  ...
  if (!hasFile) return <Tag color="default">No file</Tag>;

  const fileId = record.fileUrl.match(/\/d\/([a-zA-Z0-9-_]+)/)?.[1];
  const directUrl = fileId 
    ? `https://drive.google.com/file/d/${fileId}/preview`  // Dùng cái này là ổn nhất
    : record.fileUrl;
